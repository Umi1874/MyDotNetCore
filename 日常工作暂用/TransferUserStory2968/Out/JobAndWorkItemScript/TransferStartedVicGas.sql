...
VALUES
    (N'Transfer Started Gas VIC', N'TransferStarted Gas VIC', N'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #333333; text-align:left;line-height: 24px;">
                                                                    ...
                                                                    <p>We are about to start the transfer/switch process for the gas supply on <br /><b>@Model.NmiAddress</b>, account no <b>@Model.AccountNumber</b>, NMI/MIRN <b>@Model.Nmi</b>.</p>
                                                                    <p>
                                                                    ...
                                                                    <ul>
                                                                        <li><i>Your current retailer will give you a bigger discount.</i><br><strong>FACT :</strong> A bigger discount doesn''t mean your bill will be lower, call us and we''ll compare it for you.</li>
                                                                        <li><i>Your current retailer will charge you a termination fee.</i><br><strong>FACT :</strong>The maximum they can legally charge to end your contract is about $20 if at all</li>
                                                                        <li><i>There will be new "connection fees" or special "meter read" fees</i><br><strong>FACT :</strong> We will never charge you any additional fees when you transfer to us.</li>
																		<li><i>GloBird is a new company with only a handful of customers:</i><br><strong>FACT :</strong> GloBird was established in 2014 and is licenced by the Government. We have tens of thousands of customers and together with your help, we are proud to be making the market a more competitive place.</li>
																	</ul>
...
VALUES
    (N'Transfer Started Gas VIC', N'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                    <p>
                                                                        We are about to start the transfer/switch process for the gas supply at @Model.NmiAddress, account no @Model.AccountNumber, NMI/MIRN @Model.Nmi
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                    <p>
                                                                        Thanks for joining GloBird Energy and helping to make the energy market more competitive.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                    <p>
                                                                        We are proud to offer you low rates and excellent localised customer service.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                    <p>
                                                                        You''ll likely get a call from your old retailer trying to talk you out of your decision to switch. Competition is a good thing, so please don''t feel pressured by these tactics.  Here are just some of the things you may hear:
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table class="simple-table">
                                                                        <tr>
                                                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                                <p>Your current retailer will give you a bigger discount.</p>
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                                <p>Your current retailer will charge you a termination fee.</p>
                                                                                <p style="font-weight: bold; color: #ed268e;">FACT: In Victoria, the maximum they can legally charge to end your contract is about $20 if at all. </p>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="100%" height="10"></td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                                ...
                                                                                <p style="font-weight: bold; color: #ed268e;">FACT: We will never charge you any additional fees when you transfer to us.</p>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="100%" height="10"></td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                                ...
                                                                                <p style="font-weight: bold; color: #ed268e;">FACT: GloBird was established in 2014 and is licenced by the Government. We have tens of thousands of customers and together with your help, we are proud to be making the market a more competitive place.  </p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                    <p>If you have any queries or need further information, please give us a call on 13 3456 or 1300 516 888 (Mon to Fri 8:30am - 5:30pm).  Our professional, locally-based customer service team will be happy to assist you. </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="100%" height="10"></td>
...
VALUES(N'Transfer Started Gas VIC', N'GloBird Energy Update, Account #@Model.AccountNumber 
...
where [name] = 'Transfer Started Gas VIC')

SET @SmsTemplateId = (select [SmsTemplateId]
from crm.SmsTemplate
where [name] = 'Transfer Started Gas VIC' and LanguageCode = 'EN')
...
VALUES
    (N'Transfer Started Gas VIC', 2, @DocumentTemplateId, @EmailTemplateId, @SmsTemplateId, N'SaveFiles', N'ArchiveFiles', N'{customer id}_{account id}_{NMI}_{account service id}_{service type}_{template name}_{yyyy}_{MM}_{dd}_{HH}_{mm}_{ss}', N'admin', GETDATE(), N'admin', GETDATE())
GO
...
VALUES
    (1, N'Transfer Started Gas VIC', NULL, N'SELECT
    crma.CustomerId,
    crma.AccountId,
...
VALUES
    (N'Transfer Started Gas VIC', N'Transfer Started Gas VIC', 5, (select segmentid
        from sch.segment
        where [Name] = 'Transfer Started Gas VIC') , 0, 1, CAST(N'2019-10-22T02:30:00.0000000' AS DateTime2), N'0 30 2 ? * * *', 0, CAST(getdate() AS Date), CAST(N'9999-12-31' AS Date), getdate(), N'admin', getdate(), N'admin', 3)
go
...
BEGIN
    ...
    VALUES
        ((select jobId
            from sch.job
            where [name] = 'Transfer Started Gas VIC'), @TaskId, 1, N'{"mailMergeTemplateId":"'+cast(@MailMergeTemplateId as varchar)+N'","hasActivity":"true","workItemCategoryId":"'+cast(@WorkItemCategoryId as varchar)+N'","workItemTypeId":"'+cast(@WorkItemTypeId as varchar)+N'"}', 1, getdate(), N'admin', getdate(), N'admin')
