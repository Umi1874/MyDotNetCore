...
VALUES
    (N'Transfer Started Elec NSW', N'TransferStarted Elec NSW', N'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                                        ...
                                        <tbody>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #333333; text-align:left;line-height: 24px;">
                                                                    ...
                                                                    <p>We’ve started the transfer of your electricity service to GloBird Energy for <br /><b>@Model.NmiAddress</b>,<br/> NMI/MIRN <b>@Model.Nmi</b>.</p>
                                                                    <br/>
                                                                    ...
                                                                    <ul>
																		...
																		<li><i>You have to sign a form from them</i><br><strong>TRUTH:</strong> You shouldn’t need to sign anything, we will arrange the switch for you.</li>
                                                                    </ul>
                                            ...
                                            <tr>
                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 12px; color: #333333; text-align:left;line-height: 20px;">
                                                    ...
                                                    Phone: <a href="tel:133456" style="color:#E94071;font-weight: bold;">13 3456 </a> or <a href="tel:1300516888" style="color:#E94071;font-weight: bold;">1300 516 888</a> <br />
...
VALUES
    (N'Transfer Started Elec NSW', N'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                    <p>
                                                                        We’ve started the transfer of your gas service to GloBird Energy for @Model.NmiAddress, NMI/MIRN @Model.Nmi
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                    <p>
                                                                        At GloBird Energy, we''re proudly making the energy market more competitive with low rates and excellent localised customer service. Your old retailer will most likely call you to try and talk you out of your decision to switch. They have many high pressure tactics they might try including telling you: </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="100%" height="20"></td>
                                                                    ...
                                                                    <table class="simple-table">
                                                                        <tr>
                                                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                                ...
                                                                                <p style="font-weight: bold; color: #00b0f0;">FACT: The switch normally only takes a couple of weeks.</p>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="100%" height="10"></td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                                ...
                                                                                <p style="font-weight: bold; color: #00b0f0;">FACT: We will never charge you any additional fees when you simply transfer to us.</p>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="100%" height="10"></td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                                <p>Your have to sign a form from them.</p>
                                                                                <p style="font-weight: bold; color: #00b0f0;">FACT: You shouldn’t need to sign anything; we will arrange the switch for you.</p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #333333; text-align:left;line-height: 20px;">
                                                                    <p>If you have questions or need further information give us a call on 133456 or 1300 516 888 Monday to Friday between 8:30am-5:30pm and Saturday 10:00am-4:00pm Eastern Standard Time (minus half an hour for South Australian Time). Our professional and Melbourne based customer service team will be more than happy to assist you.</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="100%" height="10"></td>
...
where [name] = 'Transfer Started Elec NSW')

SET @SmsTemplateId = (select [SmsTemplateId]
from crm.SmsTemplate
where [name] = 'Transfer Started Elec NSW' and LanguageCode = 'EN')
...
VALUES
    (N'Transfer Started Elec NSW', 2, @DocumentTemplateId, @EmailTemplateId, @SmsTemplateId, N'SaveFiles', N'ArchiveFiles', N'{customer id}_{account id}_{NMI}_{account service id}_{service type}_{template name}_{yyyy}_{MM}_{dd}_{HH}_{mm}_{ss}', N'admin', GETDATE(), N'admin', GETDATE())
GO
...
VALUES
    (1, N'Transfer Started Elec NSW', NULL, N'SELECT
    crma.CustomerId,
    crma.AccountId,
...
VALUES
    (N'Transfer Started Elec NSW', N'Transfer Started Elec NSW', 5, (select segmentid
        from sch.segment
        where [Name] = 'Transfer Started Elec NSW') , 0, 1, CAST(N'2019-10-22T02:30:00.0000000' AS DateTime2), N'0 30 2 ? * * *', 0, CAST(getdate() AS Date), CAST(N'9999-12-31' AS Date), getdate(), N'admin', getdate(), N'admin', 3)
go
...
BEGIN
    ...
    VALUES
        ((select jobId
            from sch.job
            where [name] = 'Transfer Started Elec NSW'), @TaskId, 1, N'{"mailMergeTemplateId":"'+cast(@MailMergeTemplateIdTransferStartedElecVIC as varchar)+N'","hasActivity":"true","workItemCategoryId":"'+cast(@WorkItemCategoryId as varchar)+N'","workItemTypeId":"'+cast(@WorkItemTypeId as varchar)+N'"}', 1, getdate(), N'admin', getdate(), N'admin')
